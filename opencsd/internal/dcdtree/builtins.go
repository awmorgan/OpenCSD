...
func registerBuiltinDecoders(reg *DecoderRegister) {
	...
	_ = reg.RegisterDecoderManagerByName(ocsd.BuiltinDcdETMV3, &etmv3.DecoderManager{})
	_ = reg.RegisterDecoderManagerByName(ocsd.BuiltinDcdETMV4I, &etmv4.DecoderManager{})
	_ = reg.RegisterDecoderManagerByName(ocsd.BuiltinDcdETE, &ete.DecoderManager{})
}

...
type DecodeTreeElement struct {
	...
	DataIn          ocsd.TraceProcessor // Interface for feeding trace data
...
func NewDecodeTreeElement(name string, flagApplier common.FlagApplier, dataIn ocsd.TraceProcessor, iterator ocsd.TraceIterator, created bool) *DecodeTreeElement {

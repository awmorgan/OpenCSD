...
func NewDecodeTreeElement(name string, flagApplier common.FlagApplier, dataIn ocsd.TrcDataProcessorExplicit, iterator ocsd.TraceIterator, created bool) *DecodeTreeElement {

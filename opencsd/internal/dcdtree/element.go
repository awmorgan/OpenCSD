...
type DecodeTreeElement struct {
	...
	DecoderHandle   interfaces.TrcTypedBase // Pointer to the decoder processor (PktDecode)
...
func NewDecodeTreeElement(name string, dcdMngr interfaces.DecoderMngr, dcdHandle interfaces.TrcTypedBase, dataIn interfaces.TrcDataIn, created bool) *DecodeTreeElement {
